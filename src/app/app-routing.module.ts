...
import { FormExitGuard } from './guard/form-exit.guard';
...
const routes: Routes = [
  ...
  {path:"registroUser", component:RegistroComponent, canActivate:[RegistropermisoGuard], canDeactivate:[FormExitGuard]},
